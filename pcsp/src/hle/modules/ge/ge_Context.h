...
public:
	ge_Context()
	{
        typedef char check_size[512*4 - sizeof(ge_Context)];

		memset(this, 0, sizeof(ge_Context));
	...
	// Alpha blending
    u32	    alpha_blending_fixa;
    u32	    alpha_blending_fixb;	
    u8      alpha_blending_a;
    u8      alpha_blending_b;
...
extern ge_Context	theGeContext;
